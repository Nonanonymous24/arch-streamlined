...
/bin/echo -e "\e[1;32mInstalling KDE Plasma Desktop Environment...\e[0m"
# Sync mirrors using reflector
/bin/echo -e "\e[Syncing pacman mirrors in $COUNTRY...\e[0m"
...
sudo pacman -S --noconfirm xorg sddm neofetch plasma kde-applications firefox packagekit-qt5
...
/bin/echo -e "\e[1;32mKDE Plasma is installed.\e[0m"
# Reboot system
